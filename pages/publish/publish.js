...
Page({
  data: {
    ...
    directionList: ['东', '南', '西', '北', '东南', '西南', '西北', '东北'], // 值1-8 
    //房型
    structureList: {
      name: [
        '零', '一', '二', '三', '四', '五', '五以上'
  ...
  //室厅卫
  structureChange: function (e) {// change structure
    console.log(e)
    this.setData({
  ...
  formSubmit: function (e) {
    ...
    var variety = ''
    this.data.varieties.map(function (a) { //获取类型的id
      if (a.check) {
        variety = a.id
      }
    })
    ...
    if (addressArr.ad_info.district != '南沙区') {
      ...
      wx.request({
        ...
        data: {
          ...
          orientation: obj.directionData ? parseInt(obj.directionData) + 1 : 0,
          decoration: typeList,
