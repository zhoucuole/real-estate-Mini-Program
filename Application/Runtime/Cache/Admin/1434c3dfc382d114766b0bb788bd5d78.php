					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="#"><i class="icon fa fa-list-alt"></i>资讯管理</a></li>
								<li class="active"><i class="fa fa-plus-square-o"></i>政策列表</li>								
							</ol>						
						</div>				
					</div>
					<!-- End Page Header -->
								...
								<div class="panel-body bk-padding-bottom-40">
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
												<?php if(empty($policy)): ?><tr>
														<td colspan="13" class="center">
															<span class="text-danger">已无数据！</span>
														</td>
													</tr>
												<?php else: ?>
												<?php if(is_array($policy)): foreach($policy as $k=>$v): ?><tr>
													<td class="center"><?php echo ($k+1); ?></td>
													<td class="center"><?php echo ($v['title']); ?></td>
													<td class="center"><?php echo (nl2br($v['content'])); ?></td>
													<td class="center">
														<img width="200" src="<?php echo C('DOMAIN_NAME');?>/<?php echo ($v['avatar']); ?>" />
													</td>
...
<!-- 															<li class="bk-padding-off-right">
																<a class="bk-round bk-border-info bk-border-darken bk-bg-lighten bk-border-3x bk-icon bk-icon-default bk-bg-info" data-toggle="tooltip" data-placement="top" title="编辑" alt="编辑" data-original-title="Edit" href="/room/update?room_id=<?php echo ($v['id']); ?>">
																	<i class="fa fa-pencil"></i>
																</a>
															</li> -->
															<li class="bk-padding-off-right">
																<a class="bk-round bk-border-info bk-border-darken bk-bg-lighten bk-border-3x bk-icon bk-icon-default bk-bg-info" data-toggle="tooltip" target="_blank" data-placement="top" title="删除" alt="删除" data-original-title="Edit" onclick="delete_policy(<?php echo ($v['id']); ?>)">
									...
									<div class="actions text-center" >		
										...
										<?php if($page == 1): ?><a href="/news/policy_lst?p=1" class="btn btn-success">上一页</a>
	                                    <?php else: ?>
	                                        <a href="/news/policy_lst?p=<?php echo ($page - 1); ?>" class="btn btn-success">上一页</a><?php endif; ?>
	                                    <a href="/news/policy_lst?p=<?php echo ($page - 1); ?>" class="btn btn-success"><?php echo ($page); ?></a>
	                                    <a href="/news/policy_lst?p=<?php echo ($page + 1); ?>" class="btn btn-success">下一页</a>
									</div>
								</div>
							</div>
						</div>
		...
		<script type="text/javascript">
			...
			function delete_policy(sourceId) {

				if (confirm("确定删除该优惠政策吗 ?")) {
