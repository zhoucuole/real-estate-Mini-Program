					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="#"><i class="fa fa-list-alt"></i>资讯管理</a></li>
								<li class="active"><i class="fa fa-tags"></i>发布政策</li>
							</ol>						
						</div>			
					</div>
					<!-- End Page Header -->					
						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">
								...
								<div class="panel-body">
									<form action="/news/policy_add" method="post" enctype="multipart/form-data" class="form-horizontal ">
										<div class="tab-pane" id="tab11">
											<div class="form-group">
												<label class="col-md-4 control-label" for="title">标　　题</label>
												<div class="col-md-4">
													<input type="text" id="title" name="data[title]" class="form-control" placeholder="请输入政策标题">
												</div>
											</div>
<!-- 											<div class="form-group">
												<label class="col-md-4 control-label" for="lead">导　　语</label>
												<div class="col-md-4">
													<input type="text" id="lead" name="data[lead]" class="form-control" placeholder="请输入资讯导语">
												</div>
											</div> -->
<script type="text/javascript"> 
/** 
...
imgPre.src = url; 
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="file" id="text-input-f" name="avatar" onchange="preImg(this.id, 'img-preview', 'img-show')">
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="content">内　　容</label>
												<div class="col-md-4">
													<textarea id="content" name="data[content]" rows="9" class="form-control" placeholder="请输入政策内容"></textarea>
												</div>
											</div>
										</div>
										<div class="actions">								
