					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-tags"></i>发布资讯</li>
							</ol>						
						</div>			
					</div>
					<!-- End Page Header -->					
						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">
								...
								<div class="panel-body">
									<form action="/news/add" method="post" enctype="multipart/form-data" class="form-horizontal ">
										<div class="tab-pane" id="tab11">
											<div class="form-group">
												<label class="col-md-4 control-label" for="title">标　　题</label>
												<div class="col-md-4">
													<input type="text" id="title" name="data[title]" class="form-control" placeholder="请输入资讯标题">
												</div>
											</div>
											<div class="form-group">
...
imgPre.src = url; 
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea id="content" name="data[content]" rows="9" class="form-control" placeholder="请输入资讯内容"></textarea>
												</div>
											</div>
										</div>
										<div class="actions">								
