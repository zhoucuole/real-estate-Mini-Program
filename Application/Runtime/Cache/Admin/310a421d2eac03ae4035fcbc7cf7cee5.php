					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-plus-square-o"></i>资讯列表</li>								
							</ol>						
						</div>				
					</div>
					<!-- End Page Header -->
										...
										<table class="table">
											...
											<tbody>
												...
												<?php if(is_array($news)): foreach($news as $k=>$v): ?><tr>
													...
													<td class="center"><?php echo ($v['lead']); ?></td>
													<td class="center"><?php echo ($v['content']); ?></td>
													<td class="center">
														<img width="200" src="<?php echo C('DOMAIN_NAME');?>/<?php echo ($v['news_img']); ?>" />
													</td>
...
<!-- 															<li class="bk-padding-off-right">
															...
															<li class="bk-padding-off-right">
																<a class="bk-round bk-border-info bk-border-darken bk-bg-lighten bk-border-3x bk-icon bk-icon-default bk-bg-info" data-toggle="tooltip" target="_blank" data-placement="top" title="删除" alt="删除" data-original-title="Edit" onclick="delete_news(<?php echo ($v['id']); ?>)">
									...
									<div class="actions text-center" >		
										...
										<?php if($page == 1): ?><a href="/news/lst?p=1" class="btn btn-success">上一页</a>
	                                    <?php else: ?>
	                                        <a href="/news/lst?p=<?php echo ($page - 1); ?>" class="btn btn-success">上一页</a><?php endif; ?>
	                                    <a href="/news/lst?p=<?php echo ($page - 1); ?>" class="btn btn-success"><?php echo ($page); ?></a>
	                                    <a href="/news/lst?p=<?php echo ($page + 1); ?>" class="btn btn-success">下一页</a>
									</div>
								</div>
							</div>
						</div>
